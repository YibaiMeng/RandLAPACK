...
namespace RandLAPACK::comps::rsvd
{
        ...
        void RSVD<T>::call(
            ...
            lapack::Queue* queue // Needed for GPU
                ...
                Q.synchronize();
                LOG_F(1, "Rangefinder started");
                range_finder_obj.call(m, n, A, k, Q, queue);
                LOG_F(1, "Rangefinder finished");
                ...
                LOG_F(1, "Allocating U_tilde and VT_cpu on CPU");
                ...
                if (queue)
                {
                        ...
                        LOG_F(1, "Starting U = Q @ U_tilde on CPU");
